<template>
    <div>
      <SidebarMenu @adm="funtion"  />
        <div class="col-md-12" v-if="create==true">
            <b-button type="button" name="button" class="btn btn-danger float-right" @click="mesagge=true">Crear Equipo Nuevo</b-button>
        ...
        <div v-if="mesagge" class="overlay">
            <div class="popup">
                <h1>Crear Equipo Nuevo</h1>
                <input type="text" class="form-control col-6" id="equipo" aria-describedby="emailHelp" placeholder="Codigo equipo"  v-model.trim="form.equipo">
                <br/>
                <div class="d-flex justify-content-between">
                    <b-button type="button" name="button" variant="danger" @click="createEquipo">GUARDAR</b-button>
        ...
        <div class="user_card col-8 m-5" v-if="create==false">
            ...
            <div class="form-group row">
                <label class="col-lg-2 col-5" for="exampleInputEmail1">Equipo</label>
                <input type="text" class="form-control col-6" id="equipo" aria-describedby="emailHelp" placeholder="Codigo equipo" readonly v-model.trim="form.equipo">
            </div>
            <div class="form-group row">
                <label class="col-lg-2 col-5" for="exampleInputPassword1">Estado</label>
                <select class="form-control col-6" id="estado" placeholder="Nombre Stok" v-model="form.state">
            ...
            <div>
                <b-button type="button" name="button" class="col-lg-2 col-6" variant="danger" @click="editEquipo">GUARDAR</b-button>
  ...
  export default {
    ...
    methods:{
      ...
      getData(){
        this.isLoading = true
        const path = backendRouter.data+'equipos/admin'
      ...
      createEquipo(){
        const path = backendRouter.data+'equipos/admin'
        axios.post(path,{'equipo':this.form.equipo}).then((response)=>{
            this.mesagge=false
      ...
      selectItem(data){
        ...
        this.form.equipo = data.item.equipo
