<template>
    <div>
      <SidebarMenu @adm="funtion"  />
        <div class="col-md-12" v-if="create==true">
            <b-button type="button" name="button" class="btn btn-danger float-right" @click="mesagge=true">Crear Aerolinea Nueva</b-button>
        ...
        <div v-if="mesagge" class="overlay">
            <div class="popup">
                <h1>Crear Aerolinea Nueva</h1>
                <input type="text" class="form-control col-6" id="equipo" aria-describedby="emailHelp" placeholder="Nombre Aerolinea"  v-model.trim="form.aerolinea">
                <br/>
                <div class="d-flex justify-content-between">
                    <b-button type="button" name="button" variant="danger" @click="createAerolinea">GUARDAR</b-button>
        ...
        <div class="user_card col-8 m-5" v-if="create==false">
            ...
            <div class="form-group row">
                <label class="col-lg-2 col-5" for="exampleInputEmail1">Aerolinea</label>
                <input type="text" class="form-control col-6" id="equipo" aria-describedby="emailHelp" placeholder="Codigo equipo" readonly v-model.trim="form.aerolinea">
            </div>
            ...
            <div>
                <b-button type="button" name="button" class="col-lg-2 col-6" variant="danger" @click="editAerolinea">GUARDAR</b-button>
  ...
  export default {
    ...
    methods:{
      ...
      getData(){
        this.isLoading = true
        const path = backendRouter.data+'aerolineas/admin'
      ...
      createAerolinea(){
        const path = backendRouter.data+'aerolineas/admin'
        axios.post(path,{'aerolinea':this.form.aerolinea}).then((response)=>{
            this.mesagge=false
      ...
      selectItem(data){
        ...
        this.form.aerolinea = data.item.aerolinea
